	...
	<div class="col-md-7">
		...
		<table class="table table-hover table-stripped">
			...
			<thead>
				...
				<td>no</td><td>nama roti</td><td>kategori</td><td>harga</td><td>stok</td><td></td><td></td>
			...
			<tbody>
				...
				<tr>
					...
					<td><?=$no?></td></td><td><?=$bk->nama_roti?></td><td><?=$bk->nama_kategori?></td><td><?=$bk->harga?></td><td><?=$bk->stok?></td>

					<td> <a href="<?=base_url('index.php/Cart/tambah_cart/'.$bk->kode_roti)?>" class="btn btn-warning">Beli</a></td>
...
<table class="table table-stripped table-hover">
	...
	<tr><td colspan="2">Nama Pembeli</td><td colspan="4"><input type="text" name="pembeli" value="<?=$this->session->flashdata('pembeli');?>"></td></tr>
				...
				<th>No</th><th>nama roti</th><th>Jumlah</th><th>Harga</th><th>Subtotal</th><th></th>
			...
			<?php $no = 0; foreach($this->cart->contents() as $ct): $no++;?>
				...
				<input type="hidden" name="kode_roti[]" value="<?=$ct['id']?>">
